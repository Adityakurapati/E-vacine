...
public class Login extends JFrame {
	...
	public Login() {
		...
		lblNewLabel_10.setBounds(67, 348, 300, 14);
		panel.add(lblNewLabel_10);
		
		JLabel lblNewLabel_2 = new JLabel("");
		lblNewLabel_2.setBounds(67, 0, 410, 410);
		panel.add(lblNewLabel_2);
		lblNewLabel_2.setIcon(new ImageIcon("E:\\CPP PROJECT 2023\\Images\\vaccine\\we-can-beat-it-coronavirus-optimistic.jpg"));
